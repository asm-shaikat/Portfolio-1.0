    ...
    return (
        <div className='project-card grid place-items-center'>
            <div className="child flex ">
                <p className='lg:p-2 p-1 m-2 border-b-2 lg:border-b-2 border-b-yellow-600 text-xs lg:text-xl'>{title}</p>
                <p className='p-2 m-2 border-b-2 border-b-yellow-600 text-sm lg:text-xl'>{technology}</p>
            </div>
