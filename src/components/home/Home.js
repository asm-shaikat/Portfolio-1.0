    ...
    return (
      <div className="bg-gradient-to-r from-slate-700 to-slate-900">
              ...
              <div class="w-full lg:w-1/2">
                <div class="lg:max-w-lg ml-12">
                  ...
                  <p class="mt-4 text-white mb-2">
                    Passionate Full Stack Web Application Developer &
        ...
        <div className="myself w-full mt-20 mb-8 reveal" id="about">
          ...
          <div className="lg:flex lg:-ml-32 lg:relative items-center" id="myyself">
            <div className="lg:w-3/5">
              <img
                src="images/shaikat.png"
                className="w-full xl:w-2/3 m-auto"
                alt=""
              />
            </div>
            <div className="lg:w-2/5 ml-4 m-auto lg:-ml-60">
              <p className="font-serif text-white p-6  text-justify">
                Hi there, I'm Shaikat, a passionate Full Stack Web Application
                Developer & Competitive Programmer. I spend most of my time
                coding outstanding projects or learning something new. Apart
                from Web Development, I also love machine learning.
              </p>
            </div>
          </div>
        </div>
              ...
              <div class="lg:w-1/2 lg:mx-10">
                ...
                <form className="px-8 pt-6 pb-8 mb-4 ">
                  ...
                  <div className="mb-4">
                    ...
                    <textarea
                      className="bg-slate-700 w-full text-white textarea border-accent"
                  ...
                  <button class="w-full px-6 py-3 mt-4 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-blue-500 rounded-md hover:bg-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-50">
                    <FontAwesomeIcon
                      className="text-yellow-500 fa-2x"
                      icon={faPaperPlane}
                    />
                  </button>
                </form>
